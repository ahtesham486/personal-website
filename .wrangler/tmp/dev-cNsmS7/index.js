...
// worker/index.js
var HOME_MARKDOWN = `# Ahtasham Aslam

> Python Developer & AI Automation Specialist \xB7 Lahore, Pakistan
...
`;
var LINK_HEADER = '</.well-known/api-catalog>; rel="api-catalog", </llms.txt>; rel="alternate"; type="text/plain", </llms-full.txt>; rel="describedby"; type="text/plain", </.well-known/agent-skills/index.json>; rel="agent-skills", </.well-known/mcp/server-card.json>; rel="mcp-server-card", </auth.md>; rel="author"; type="text/markdown", </sitemap.xml>; rel="sitemap"; type="application/xml"';
var worker_default = {
...
// .wrangler/tmp/bundle-4NvjDf/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-4NvjDf/middleware-loader.entry.ts
